...
class HeaderTemplate
{
    public function header()
    {
        ...
        $headerContent .= "<ul id='menuDropdown' class='hidden absolute top-10 left-0 mt-2 py-2 bg-white border border-gray-300 rounded-lg shadow-lg'>";
        $headerContent .= "<li><a href='#' class='block px-4 py-2 hover:bg-gray-200'>Option 1</a></li>";
        $headerContent .= "<li><a href='#' class='block px-4 py-2 hover:bg-gray-200'>Option 1</a></li>";
        $headerContent .= "<li><a href='#' class='block px-4 py-2 hover-bg-gray-200'>Option 1</a></li>";
        $headerContent .= "</ul>";
        $headerContent .= "</div>";
        $headerContent .= "<ul class='flex gap-4'>";
        ...
        $headerContent .= "</ul>";
        $headerContent .= "<div>";
        $headerContent .= "<p>Barre de recherche</p>";
        $headerContent .= "</div>";
        $headerContent .= "</menu>";
        $headerContent .= "</div>";
        $headerContent .= "</header>";
